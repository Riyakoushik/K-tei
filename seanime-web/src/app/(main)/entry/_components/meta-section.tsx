...
import { useHasDebridService, useServerStatus } from "@/app/(main)/_hooks/use-server-status"
...
export function MetaSection(props: { entry: Anime_Entry, details: AL_AnimeDetailsById_Media | undefined }) {
    ...
    const { currentView, setView, isLibraryView, isDebridStreamingView, isOnlineStreamingView } = useAnimeEntryPageView()
