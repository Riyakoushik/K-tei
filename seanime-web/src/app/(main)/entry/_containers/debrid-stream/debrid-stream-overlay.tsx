...
export function DebridStreamOverlay() {
    ...
    const confirmCancelAndRemoveTorrent = useConfirmationDialog({
        title: "Cancel and remove stream",
        description: "Are you sure you want to cancel the stream and remove the cached file?",
        onConfirm: () => {
            cancelStream({
                options: {
                    removeTorrent: true,
                ...
                <AppLayoutStack>
                    ...
                    <div className="flex justify-center gap-1 mt-4">
                        <Button
                            ...
                            intent="alert-basic"
                            disabled={isCancelling || state?.status !== "downloading" || state?.message === "Downloading stream..."}
                            size="sm"
                        >
                            Cancel
                        </Button>
