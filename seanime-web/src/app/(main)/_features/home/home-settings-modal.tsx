...
export function HomeSettingsModal({ emptyLibrary, isNakamaLibrary }: { emptyLibrary?: boolean, isNakamaLibrary: boolean }) {
    ...
    const animeLibraryType = (serverStatus?.debridSettings?.includeDebridStreamInLibrary || serverStatus?.settings?.library?.includeOnlineStreamingInLibrary)
        ?
        "stream"
        : "local"
                ...
                <div className="space-y-6">
                    <div>
                        ...
                        <RadioGroup
                            ...
                            disabled={isSavingSettings || isSavingDebridSettings}
                            options={[
