...
export function SeaCommandUserMediaNavigation() {
    ...
    const q = args.join(" ") // Assuming args is an array of strings and we want to join them to form the query

    const filteredAnime = (command === "anime" && q.length > 0) ? anime.filter(n => seaCommand_compareMediaTitles(n.title, q)) : []
