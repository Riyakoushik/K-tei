...
export const MediaEntryCard = React.memo(<T extends "anime" | "manga">(props: MediaEntryCardProps<T>) => {
    ...
    const MANGA_LINK = React.useMemo(() => `/manga/entry?id=${mediaId}`, [mediaId])
    const ANIME_LINK = React.useMemo(() => `/entry?id=${mediaId}`, [mediaId])
...
}) as <T extends "anime" | "manga">(props: MediaEntryCardProps<T>) => React.ReactElement
