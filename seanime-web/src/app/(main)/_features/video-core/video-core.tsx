...
import {
    __debridSearch_fileSelectionStreamAtom,
...
export function VideoCore(props: VideoCoreProps) {
    ...
    if (inline) {
        return (
            <ScopeProvider atoms={[__debridSearch_selectionAtom, __debridSearch_selectionEpisodeAtom, __debridSearch_fileSelectionStreamAtom]}>
                <VideoCoreAnime4K />
