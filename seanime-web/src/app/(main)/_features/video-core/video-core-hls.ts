    ...
    useEffect(() => {
        ...
        if (Hls.isSupported()) {
            ...
            const hls = new Hls({
                ...
                backBufferLength: 90,
                maxBufferLength: 120, // Guarantee at least 120 seconds ahead
                maxMaxBufferLength: 600, // Allow up to 10 minutes ahead if memory permits
                maxBufferSize: 100 * 1000 * 1000, // Allow up to 100MB of buffer
                enableWebVTT: true,
