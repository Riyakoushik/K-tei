...
export function PlaybackSettings(props: PlaybackSettingsProps) {
    ...
    return (
        <>
            ...
            {(!externalPlayerLink && (downloadedMediaPlayback === PlaybackDownloadedMedia.ExternalPlayerLink || streamStreamingPlayback === PlaybackStreamStreaming.ExternalPlayerLink)) && (
                <Alert
                    intent="alert-basic"
                    description={
            ...
            <SettingsCard
                ...
                description="Choose how to play streamed content from debrid services"
                className={cn(
                    "transition-all duration-200",
                    usingNativePlayer && "opacity-50",
                )}
                ...
                <div className="space-y-4">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                        ...
                        <div
                            className={cn(
                                "p-4 rounded-lg border cursor-pointer transition-all",
                                streamStreamingPlayback === PlaybackStreamStreaming.Default
                                    ? "border-[--brand] bg-brand-900/10"
                                    : "border-gray-700 hover:border-gray-600",
                            )}
                            onClick={() => {
                                setStreamStreamingPlayback(PlaybackStreamStreaming.Default)
                                toast.success("Playback settings updated")
                            }}
                        >
                            <div className="flex items-start gap-3">
                        ...
                        <div
                            className={cn(
                                "p-4 rounded-lg border cursor-pointer transition-all",
                                streamStreamingPlayback === PlaybackStreamStreaming.ExternalPlayerLink
                                    ? "border-[--brand] bg-brand-900/10"
                                    : "border-gray-700 hover:border-gray-600",
                            )}
                            onClick={() => {
                                setStreamStreamingPlayback(PlaybackStreamStreaming.ExternalPlayerLink)
                                toast.success("Playback settings updated")
                            }}
                        >
                            <div className="flex items-start gap-3">
