...
export function useGetStreamSettings() {
...
export function useGetStreamTorrentFilePreviews(variables: Partial<GetTorrentstreamTorrentFilePreviews_Variables>, enabled: boolean) {
...
export function useGetStreamBatchHistory(mediaId: Nullish<string | number>, enabled: boolean) {
