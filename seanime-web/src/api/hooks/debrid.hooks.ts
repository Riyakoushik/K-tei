...
export function useDebridAddStreams(onSuccess: () => void) {
    const qc = useQueryClient()
...
export function useDebridDownloadStream() {
...
export function useDebridDeleteStream() {
    const qc = useQueryClient()
...
export function useDebridGetStreams(enabled: boolean, refetchInterval: number) {
...
export function useDebridGetStreamInfo(variables: Partial<DebridGetTorrentInfo_Variables>, enabled: boolean) {
...
export function useDebridGetStreamFilePreviews(variables: Partial<DebridGetTorrentFilePreviews_Variables>, enabled: boolean) {
