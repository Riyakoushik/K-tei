...
type Manager interface {
	...
	// SynchronizeSimulatedCollectionToAnilist synchronizes the simulated anime collection to the user's AniList account.
...
func (m *ManagerImpl) synchronize(lfs []*anime.LocalFile) error {

	m.logger.Trace().Msg("local manager: Synchronizing local database with user's anime collection")
